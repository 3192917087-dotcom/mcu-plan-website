...
const assertions = [
  ...
  ['第四章流程图按共享逻辑归组', prompts.includes('groupFlowchartFunctions') && prompts.includes('将同类程序和功能逻辑归入一张核心流程图') && app.includes('functionalFlowcharts.length > 2')],
  ['第五章展示图按结果场景归组', prompts.includes('groupResultScenes') && prompts.includes('同一器件、同一屏幕页面或同一动作状态不得反复安排图片') && app.includes('resultImages.length > 3')],
